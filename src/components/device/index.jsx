...
const Devices = ({laptop= true, img= ''}) => {
  ...
  return (
    ...
    <div className=''>
        <div className="relative mx-auto border-gray-800  bg-gray-800  border-[8px] rounded-t-xl h-[172px] max-w-[331px] md:h-[294px] md:max-w-[512px]">
  ...
  :
   ...
   <>
     <div className="relative mx-auto border-gray-800 dark:border-gray-800 bg-gray-800 border-[16px] rounded-t-xl h-[172px] max-w-[331px] md:h-[294px] md:max-w-[512px]">
